...
(async function () {
  ...
  let LOCAL_MAP_RADIUS = parseInt(
    localStorage.getItem("LOCAL_MAP_RADIUS") || 5,
  );
  ...
  const BUILDING_TYPES = {
    ...
    45: {
      ...
      color: "#818589",
      border: "3px solid #525252",
      name: "Fort Creedy Exercise Yard",
      icon: "",
    },
    46: {
      visible: true,
      color: "#818589",
      name: "Fort Creedy Gatehouse",
      icon: "🛂",
    },
    47: {
      visible: true,
    ...
    49: {
      ...
      color: "#818589",
      border: "3px solid #525252",
      name: "Fort Creedy Training Ground",
      icon: "",
    },
    50: {
      visible: true,
      color: "#818589",
      border: "3px solid #525252",
      name: "Fort Creedy Vehicle Depot",
      icon: "🧰",
    },
    ...
    53: {
      ...
      color: "#818589",
      border: "3px solid #525252",
      name: "Fort Perryn Exercise Yard",
      icon: "",
    },
    54: {
      visible: true,
      color: "#818589",
      name: "Fort Perryn Gatehouse",
      icon: "🛂",
    },
    55: {
      visible: true,
    ...
    57: {
      ...
      color: "#818589",
      border: "3px solid #525252",
      name: "Fort Perryn Training Ground",
      icon: "",
    },
    58: {
      visible: true,
      color: "#818589",
      border: "3px solid #525252",
      name: "Fort Perryn Vehicle Depot",
      icon: "🧰",
    },
  };
...
`;
  ...
  function createCitySuburbLinks(suburbName) {
    ...
    wikiLink.href =
      "http://wiki.urbandead.com/index.php/" + suburbSafe + "#Suburb_Map";
    ...
    dssLink.href =
      "https://web.archive.org/web/20160613225203/http://map.dssrzs.org/" +
      suburbSafe;
    ...
    for (let y = 0; y < 10; y++) {
      ...
      `;
        ...
        td.addEventListener("mouseenter", () => {
          ...
          const displayName = isPlayerSuburb
            ? suburbNames[y][x] + " (You)"
            : suburbNames[y][x];
